 ...
 */
package de.hybris.tatacliq.fulfilmentprocess.actions.order;
...
public class FraudCheckOrderAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	public Transition executeAction(final OrderProcessModel process)
	{
		...
		final double scoreLimit = Double.parseDouble(Config.getParameter(TatacliqFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreLimitExternal"));
		final double scoreTolerance = Double.parseDouble(Config.getParameter(TatacliqFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreToleranceExternal"));
