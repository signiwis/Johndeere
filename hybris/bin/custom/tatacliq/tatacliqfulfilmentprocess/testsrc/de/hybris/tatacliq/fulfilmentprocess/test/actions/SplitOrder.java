 ...
 */
package de.hybris.tatacliq.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(TatacliqFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TatacliqFulfilmentProcessConstants.PARENT_PROCESS);
