 ...
 */
package de.hybris.tatacliq.fulfilmentprocess.test.jobs;
...
import de.hybris.tatacliq.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = TatacliqFulfilmentProcessConstants.ORDER_PROCESS_NAME;
