 ...
 */
package de.hybris.tatacliq.cockpits.setup;
...
import de.hybris.tatacliq.cockpits.constants.TatacliqCockpitsConstants;
 ...
 */
@SystemSetup(extension = TatacliqCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(TatacliqCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(TatacliqCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						TatacliqCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/tatacliqcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
