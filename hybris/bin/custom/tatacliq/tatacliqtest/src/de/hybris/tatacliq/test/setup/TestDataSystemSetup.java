 ...
 */
package de.hybris.tatacliq.test.setup;
...
import de.hybris.tatacliq.test.constants.TatacliqTestConstants;
import de.hybris.tatacliq.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TatacliqTestConstants.EXTENSIONNAME)
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			else
			{
				...
				importImpexFile(context, "/tatacliqtest/import/qa-test-users.impex");

				LOG.info("Creating Reviews...");
				importImpexFile(context, "/tatacliqtest/import/reviews.impex");
				...
				importImpexFile(context, "/tatacliqtest/import/cstickets.impex");

				LOG.info("Creating Test Quotes...");
				importImpexFile(context, "/tatacliqtest/import/csquotes.impex");
			}
		}
	}
}
