 ...
 */
package de.hybris.tatacliq.core.strategies.impl;
...
import de.hybris.tatacliq.core.model.JhondeereSizeVariantProductModel;
import de.hybris.tatacliq.core.model.JhondeereStyleVariantProductModel;
 ...
 */
public class JhondeereSizeProductReferenceTargetStrategy implements ProductReferenceTargetStrategy
{
	...
	public ProductModel getTarget(final ProductModel sourceProduct, final ProductReferenceModel reference)
	{
		...
		if (sourceProduct instanceof JhondeereSizeVariantProductModel
				&& reference.getTarget() instanceof JhondeereStyleVariantProductModel)
		{
			...
			if (CollectionUtils.containsAny(sourceSuperCategories, targetSuperCategories))
			{
				...
				final String size = ((JhondeereSizeVariantProductModel) sourceProduct).getSize();
	...
	protected VariantProductModel getVariantWithSameSize(final ProductReferenceModel reference, final String size)
	{
		...
		{
			if (variant instanceof JhondeereSizeVariantProductModel
					&& size.equals(((JhondeereSizeVariantProductModel) variant).getSize()))
			{
				return variant;
			}
		}
