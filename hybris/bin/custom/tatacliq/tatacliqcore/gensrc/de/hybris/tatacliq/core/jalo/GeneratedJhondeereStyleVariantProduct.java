...
/**
 * Generated class for type {@link de.hybris.tatacliq.core.jalo.JhondeereStyleVariantProduct JhondeereStyleVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedJhondeereStyleVariantProduct extends VariantProduct
{
	/** Qualifier of the <code>JhondeereStyleVariantProduct.style</code> attribute **/
	public static final String STYLE = "style";
	/** Qualifier of the <code>JhondeereStyleVariantProduct.swatchColors</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JhondeereStyleVariantProduct.style</code> attribute.
	...
	public String getStyle(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedJhondeereStyleVariantProduct.getStyle requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JhondeereStyleVariantProduct.style</code> attribute. 
	...
	public void setStyle(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedJhondeereStyleVariantProduct.setStyle requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JhondeereStyleVariantProduct.swatchColors</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JhondeereStyleVariantProduct.swatchColors</code> attribute. 
