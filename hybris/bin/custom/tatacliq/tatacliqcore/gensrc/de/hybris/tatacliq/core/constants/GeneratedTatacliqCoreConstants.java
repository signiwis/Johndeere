 ...
 *  
 */
package de.hybris.tatacliq.core.constants;
...
public class GeneratedTatacliqCoreConstants
{
	public static final String EXTENSIONNAME = "tatacliqcore";
	public static class TC
	{
		...
		public static final String JHONDEEREPRODUCT = "JhondeereProduct".intern();
		public static final String JHONDEERESIZEVARIANTPRODUCT = "JhondeereSizeVariantProduct".intern();
		public static final String JHONDEERESTYLEVARIANTPRODUCT = "JhondeereStyleVariantProduct".intern();
	...
	protected GeneratedTatacliqCoreConstants()
	{
		// private constructor
	}
