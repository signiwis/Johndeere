...
import de.hybris.tatacliq.core.jalo.JhondeereStyleVariantProduct;
import java.util.Collections;
import java.util.HashMap;
import java.util.Map;

/**
 * Generated class for type {@link de.hybris.tatacliq.core.jalo.JhondeereSizeVariantProduct JhondeereSizeVariantProduct}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedJhondeereSizeVariantProduct extends JhondeereStyleVariantProduct
{
	/** Qualifier of the <code>JhondeereSizeVariantProduct.size</code> attribute **/
	public static final String SIZE = "size";
	protected static final Map<String, AttributeMode> DEFAULT_INITIAL_ATTRIBUTES;
	static
	{
		final Map<String, AttributeMode> tmp = new HashMap<String, AttributeMode>(JhondeereStyleVariantProduct.DEFAULT_INITIAL_ATTRIBUTES);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>JhondeereSizeVariantProduct.size</code> attribute.
	...
	public String getSize(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedJhondeereSizeVariantProduct.getSize requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>JhondeereSizeVariantProduct.size</code> attribute. 
	...
	public void setSize(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedJhondeereSizeVariantProduct.setSize requires a session language", 0 );
		}
