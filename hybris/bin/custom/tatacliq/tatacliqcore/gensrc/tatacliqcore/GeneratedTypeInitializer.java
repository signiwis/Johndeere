...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"ApparelProduct",
			"Product",
			de.hybris.tatacliq.core.jalo.ApparelProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			de.hybris.tatacliq.core.jalo.ApparelStyleVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"ApparelStyleVariantProduct",
			de.hybris.tatacliq.core.jalo.ApparelSizeVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"JhondeereProduct",
			"Product",
			de.hybris.tatacliq.core.jalo.JhondeereProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"JhondeereStyleVariantProduct",
			"VariantProduct",
			de.hybris.tatacliq.core.jalo.JhondeereStyleVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"JhondeereSizeVariantProduct",
			"JhondeereStyleVariantProduct",
			de.hybris.tatacliq.core.jalo.JhondeereSizeVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			de.hybris.tatacliq.core.jalo.ElectronicsColorVariantProduct.class,
			null,
			false,
			null,
			false
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_JhondeereProduct_genders();
			
				single_createattr_JhondeereStyleVariantProduct_style();
			
				single_createattr_JhondeereStyleVariantProduct_swatchColors();
			
				single_createattr_JhondeereSizeVariantProduct_size();
	...
	public void single_createattr_JhondeereProduct_genders() throws JaloBusinessException
	{
	...
	public void single_createattr_JhondeereStyleVariantProduct_style() throws JaloBusinessException
	{
	...
	public void single_createattr_JhondeereStyleVariantProduct_swatchColors() throws JaloBusinessException
	{
	...
	public void single_createattr_JhondeereSizeVariantProduct_size() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createEnumerationValues(
			...
			single_setAttributeProperties_JhondeereProduct_genders();
			...
			single_setAttributeProperties_JhondeereStyleVariantProduct_style();
		
			single_setAttributeProperties_JhondeereStyleVariantProduct_swatchColors();
			...
			single_setAttributeProperties_JhondeereSizeVariantProduct_size();
			...
			single_setAttributeProperties_ElectronicsColorVariantProduct_color();
				...
				setDefaultProperties(
					...
					null
						...
						public void single_setAttributeProperties_JhondeereProduct_genders() throws JaloBusinessException
						{
						...
						public void single_setAttributeProperties_JhondeereStyleVariantProduct_style() throws JaloBusinessException
						{
						...
						public void single_setAttributeProperties_JhondeereStyleVariantProduct_swatchColors() throws JaloBusinessException
						{
						...
						public void single_setAttributeProperties_JhondeereSizeVariantProduct_size() throws JaloBusinessException
						{
