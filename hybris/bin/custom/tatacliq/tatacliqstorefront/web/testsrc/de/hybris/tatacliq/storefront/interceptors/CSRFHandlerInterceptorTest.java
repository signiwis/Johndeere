 ...
 */
package de.hybris.tatacliq.storefront.interceptors;
...
import de.hybris.tatacliq.storefront.util.CSRFHandlerInterceptor;
import de.hybris.tatacliq.storefront.util.CSRFTokenManager;
...
public class CSRFHandlerInterceptorTest extends ServicelayerTest
{
	...
	private static final String SESSION_CSRF_ATTRIBUTE = "de.hybris.tatacliq.storefront.util.CSRFTokenManager.tokenval";
